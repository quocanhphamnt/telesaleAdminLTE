$( document ).ready(function() {
    ...
    $('.fa-adjust').on('click', function () {
        if ($('body').hasClass('dark-mode')) {
            ...
            $('.control-sidebar').addClass('sidebar-light-primary')
            $('.control-sidebar').removeClass('sidebar-dark-primary')
        } else {
            ...
            $('.control-sidebar').removeClass('sidebar-light-primary')
            $('.control-sidebar').addClass('sidebar-dark-primary')
        }
    })
});
